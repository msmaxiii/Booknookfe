...
<div id="box3">
       <div className ="B7" style={{ backgroundImage: `url(${DIRT})`,height:"230px",width:"140px",backgroundSize:"cover"}}>
       </div>

       <div className ="B8" style={{ backgroundImage: `url(${BLACK_DOG})`,height:"230px",width:"140px",backgroundSize:"cover"}}>
       </div>

       <div className ="B9" style={{ backgroundImage: `url(${SKIN_GAME})`,height:"230px",width:"140px",backgroundSize:"cover"}}>
       </div> 
